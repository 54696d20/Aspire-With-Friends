...
public class CreateLocationHandler : BaseHandler
{
    ...
    public CreateLocationHandler(IDbConnectionFactory connectionFactory, IMessageBus bus, ILogger<CreateLocationHandler> logger, ICacheService cache)
        : base(cache, logger)
    {
    ...
    public async Task<int> Handle(CreateLocationCommand command)
    {
        ...
        try
        {
            ...
            // Invalidate cache using base class method
